...
const navigationItems = [
  ...
  { title: "Asset Inventory", url: "/pages/office/inventory", icon: UserPlus2 },
  { title: "College", url: "/pages/office/college", icon: UserPlus2 },
]
...
export function SideBarOffice({ className }: AppSidebarProps) {
