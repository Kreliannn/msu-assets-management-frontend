...
interface AuditTrailReportModalProps {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function AuditTrailReportModal({
  open,
  onOpenChange,
}: AuditTrailReportModalProps) {
  ...
  const load = async () => {
    ...
    try {
      ...
      const data = res.data as logsInterface[]
      setRows(
        data.map((l) => ({
          type: l.type,
          entity: l.entity,
